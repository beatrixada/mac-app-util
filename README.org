...
This is a fork of [[https://github.com/hraban/mac-app-util][hraban/mac-app-util]] with modifications by [[https://github.com/beatrixada][beatrixada]], 2026.
...
*** flake-parts (recommended)

If your flake uses [[https://flake.parts][flake-parts]], you can import mac-app-util as a flake module. This gives you access to all its outputs (packages, home-manager module, nix-darwin module) as a composable flake-parts module:
...
#+begin_src nix
{
  ...
  outputs = inputs: inputs.flake-parts.lib.mkFlake { inherit inputs; } {
    imports = [
      mac-app-util.flakeModules.default
    ];
    # mac-app-util's packages, checks, and formatter are now available
    # in your perSystem config.
  };
}
#+end_src

The home-manager and nix-darwin modules are still available as =mac-app-util.homeManagerModules.default= and =mac-app-util.darwinModules.default= respectively, and can be used exactly as shown below.
...
Copyright © 2025–2026  beatrixada (fork modifications)
